...
class InnController extends Controller
{
    ...
    public function find(Request $request)
    {
        ...
        $param = ['form' => $request, 'items' => $items, 'user_id' => Auth::id()];
    ...
    public function confirm(Request $request)
    {
        ...
        return view('inn.add_confirm', compact("param"));
    }
    ...
    {
        Verify::isAdminUser();
        return view('inn.find_admin', ['input' => '']);
    }
    ...
    { //宿更新
        ...
        return view('inn.update', ['form' => $item[0]]);
    }
    public function confirm1(Request $request)
    {
        ...
        $param = $request->all();
        $request->session()->put($param); // １）
        return view('inn.update_confirm', compact("param"));
    }
    public function update(Request $request)
    {
        ...
        return redirect('/inn/inn_info?id=' . $param['id']);
    }
    public function delete(Request $request)
    { //宿削除
        Verify::isAdminUser();
        $inn = Inn::find($request->id);
        return view('inn.del', ['form' => $inn]);
    }
